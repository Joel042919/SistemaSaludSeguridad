declare global {
  ...
  const requireAdmin: typeof import('../../server/utils/admin').requireAdmin
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from 'C:/UNIVERSIDAD/10 - CICLO/ING_SOFTWARE II/SEMANA_15/seguridadSalud/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from 'C:/UNIVERSIDAD/10 - CICLO/ING_SOFTWARE II/SEMANA_15/seguridadSalud/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { requireAdmin } from 'C:/UNIVERSIDAD/10 - CICLO/ING_SOFTWARE II/SEMANA_15/seguridadSalud/server/utils/admin';
export { prisma } from 'C:/UNIVERSIDAD/10 - CICLO/ING_SOFTWARE II/SEMANA_15/seguridadSalud/server/utils/prisma';